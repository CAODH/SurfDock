...
parser.add_argument('--out_file', type=str, default="~/prepared_PDBBIND_for_esm.fasta")
parser.add_argument('--protein_ligand_csv', type=str, default='~/PDBBIND.csv', help='Path to a .csv specifying the input as described in the main README')
